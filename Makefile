...
SOURCES = \
	__init__.py \
	cad_importer.py cad_importer_dialog.py

PLUGINNAME = cad_importer

PY_FILES = \
	__init__.py \
	cad_importer.py cad_importer_dialog.py

UI_FILES = cad_importer_dialog_base.ui
...
QGISDIR=C:\Users\Dimitar\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
